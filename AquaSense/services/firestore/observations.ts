...
export async function salvarObservacao(input: ObservacaoInput): Promise<string> {
    const usuarioId = input.usuarioId ?? input.criadoPor;
...
export async function buscarObservacoesPorCorpo(
    ...
    try {
        ...
        console.error("[buscarObservacoesPorCorpo] Erro:", e);
        return [];
    }
}

export async function buscarObservacoesPorUsuario(
    usuarioId: string,
    maxItems = 20
): Promise<Observacao[]> {
    try {
        ...
        console.error("[buscarObservacoesPorUsuario] Erro:", e);
        return [];
    }
}

export async function buscarObservacoesPorArea(
    areaChave: string,
    maxItems = 20
): Promise<Observacao[]> {
    try {
        ...
        console.error("[buscarObservacoesPorArea] Erro:", e);
        return [];
    }
}

export function observacaoToDate(value: any): Date {
