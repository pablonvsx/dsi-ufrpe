...
import {
  fetchGestorProfile,
  updateGestorEmail,
  deactivateGestorAccount,
  deleteGestorAccount,
  recordGestorLastAccess,
  GestorProfileData,
  GestorStats,
...
export default function PerfilGestorScreen() {
  ...
  const initials = managerData.nome
    ? managerData.nome.charAt(0).toUpperCase()
    : 'G';
            ...
            <View style={styles.profileRow}>
              <View style={styles.avatarBlock}>
                <View style={styles.avatarCircle}>
                  <Text style={[styles.avatarText, { fontFamily: questrial }]}>
                    {initials}
                  </Text>
                </View>
              ...
              <View style={styles.profileInfo}>
                ...
                <View style={styles.roleBadge}>
                  <Text style={[styles.roleBadgeText, { fontFamily: questrial }]}>
                    {managerData.cargo}
                  </Text>
                </View>
                ...
                <View style={styles.emailRow}>
                  ...
                  <Text style={[styles.profileEmail, { fontFamily: questrial }]}>
                    {' '}
                    {managerData.email}
                  </Text>
                </View>
              ...
              <View style={styles.regionCard}>
                <View style={styles.regionCardTop}>
                  ...
                  <Text style={[styles.regionCardLabel, { fontFamily: questrial }]}>
                    {' '}
                    Região gerenciada
                  </Text>
                </View>
                ...
                <Text style={[styles.regionCardUnit, { fontFamily: questrial }]}>
                  {managerData.unidade}
                </Text>

                <Text style={[styles.regionCardLink, { fontFamily: questrial }]}>
        ...
        >
          {error && (
            <View style={styles.errorBanner}>
              ...
              <Text style={[styles.errorText, { fontFamily: questrial }]}>
                {error}
              </Text>

              <TouchableOpacity onPress={() => user && fetchProfile(user.uid)}>
                <Text style={[styles.errorRetry, { fontFamily: questrial }]}>
                  Tentar novamente
                </Text>
              </TouchableOpacity>
            </View>
          ...
          {loading ? (
            ...
            <>
              ...
              <View style={styles.card}>
                <View style={styles.accountRow}>
                  <View style={styles.accountRowLeft}>
                    ...
                    <View>
                      <Text style={[styles.accountLabel, { fontFamily: questrial }]}>
                        E-mail
                      </Text>
                  ...
                  >
                    ...
                    <Text style={[styles.alterBtnText, { fontFamily: questrial }]}>
                      {' '}
                      Alterar
                    </Text>
                  </TouchableOpacity>
              ...
              >
                ...
                <Text style={[styles.signOutText, { fontFamily: questrial }]}>
                  Sair da conta
                </Text>
        ...
        <Modal visible={modalSignOutVisible} transparent animationType="fade">
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              ...
              <Text style={[styles.modalTitle, { fontFamily: questrial, color: PRIMARY }]}>
                Sair da conta
              </Text>
              ...
              <View style={styles.modalBtns}>
                <TouchableOpacity
                  onPress={() => setModalSignOutVisible(false)}
                  style={styles.modalBtnCancel}
                >
                  <Text style={{ color: TEXT_MUTED, fontFamily: questrial }}>
                    Cancelar
                  </Text>
                </TouchableOpacity>
                ...
                >
                  <Text style={{ color: '#fff', fontWeight: '700', fontFamily: questrial }}>
                    Sair
                  </Text>
                </TouchableOpacity>
              </View>
        ...
        <Modal visible={modalDeactivateVisible} transparent animationType="fade">
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              ...
              <Text style={[styles.modalTitle, { fontFamily: questrial, color: '#e67e22' }]}>
                Desativar conta
              </Text>
              ...
              <View style={styles.modalBtns}>
                <TouchableOpacity
                  onPress={() => setModalDeactivateVisible(false)}
                  style={styles.modalBtnCancel}
                >
                  <Text style={{ color: TEXT_MUTED, fontFamily: questrial }}>
                    Cancelar
        ...
        <Modal visible={modalDeleteVisible} transparent animationType="fade">
          <View style={styles.modalOverlay}>
            <View style={styles.modalContent}>
              ...
              <Text style={[styles.modalTitle, { fontFamily: questrial, color: '#c0392b' }]}>
                Excluir conta
              </Text>
...
const styles = StyleSheet.create({
  ...
  modalOverlay: {
    flex: 1,
    backgroundColor: 'rgba(0,77,72,0.4)',
    justifyContent: 'center',
    alignItems: 'center',
    padding: 24,
  },
